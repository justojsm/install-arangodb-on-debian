...
catalog.workflow({name: "build", desc: "Build the package."}, function(params) {
  ...
  copy(
    "Create package",
    {
      ...
      dst: "dist/es5/nodejs/install-arangodb-on-ubuntu/"
    },
    {
      src: "build/es5/lib/",
      dst: "dist/es5/nodejs/install-arangodb-on-ubuntu/lib",
      force: true
    },
    {
...
catalog.simple({
  ...
  params: {
    who: "justojs",
    src: "dist/es5/nodejs/install-arangodb-on-ubuntu"
  }
});
...
catalog.simple({
  ...
  task: npm.install,
  params: {
    pkg: "./dist/es5/nodejs/install-arangodb-on-ubuntu",
    global: true,
    output: false
  }
});
